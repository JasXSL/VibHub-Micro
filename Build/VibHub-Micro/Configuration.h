...
#define CTASK_BOARD_STATUS "sb"                 // Capable of reporting board status (incl battery, temperature)
...
#define CTASK_TEMPERATURE "temp"                // Capable of reporting temperature on the board in CTASK_BOARD_STATUS
#define CTASK_BATTERY_LEVEL "bat"               // Capable of reporting battery level in CTASK_BOARD_STATUS

#define CTASK_BOARD_STATUS_IN "gb"              // Only received, not sent
...
namespace Configuration{
	...
	const uint8_t NR_CAPABILITIES   = 8;
